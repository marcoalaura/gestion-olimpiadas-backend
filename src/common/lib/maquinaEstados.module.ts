...
export const maquinaEstadosPregunta = (currentStatus) => {
  ...
  const fsm = new StateMachine({
    init: currentStatus,
    transitions: [
      { name: Transition.ENVIAR, from: Status.CREATE, to: Status.ENVIADO },
      { name: Transition.ELIMINAR, from: Status.CREATE, to: Status.ELIMINADO },
      { name: Transition.APROBAR, from: Status.ENVIADO, to: Status.APROBADO },
      { name: Transition.OBSERVAR, from: Status.ENVIADO, to: Status.OBSERVADO },
      { name: Transition.ENVIAR, from: Status.OBSERVADO, to: Status.ENVIADO },
      { name: Transition.ANULAR, from: Status.APROBADO, to: Status.ANULADO },
    ],
    methods: {},
  });
