...
export class fakeEtapaAreaGradoCalendario3627667477604 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const etapasItems = [{
      id: TextService.textToUuid(`etapa1-carga-empaquetado${INITIAL}`),
      nombre: `Etapa 1 carga - empaquetado simple ${INITIAL}`,
    ...
    const eagsItems = [
      {
        id: TextService.textToUuid(`eag-carga-matematicas-empaquetado${INITIAL}`),
        total_preguntas: 20,
        ...
        id_etapa: TextService.textToUuid(`etapa1-carga-empaquetado${INITIAL}`),
        id_grado_escolar: 'c9930379-5dc1-556f-847c-802dd9d1d9b6',// PRIMERO SECUNDARIA
        id_medallero: TextService.textToUuid(`medallero-matematicas-empaquetado${INITIAL}`)
      },
    ];
