...
export class fakeEstudiantesInscripcionQuimica1627667477311 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    _medallero.id = TextService.textToUuid(`medallero-quimica-${INITIAL}`)
