...
export class fakePreguntasImagenes1627667477307 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // PREGUNTAS NIVEL BASICO
      for (let idx = 0; idx < tam; idx++) {
        ...
        _pregunta.idEtapaAreaGrado = TextService.textToUuid(`eag-carga-quimica-${INITIAL}`); //'793e2227-770d-5692-8852-d9efdcc6a4d7';
