...
export class fakeOlimpiadaCarga1627667477303 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const olimpiadasItems = [
      {
        id: TextService.textToUuid(`olimpiada-carga-${INITIAL}`),
        nombre: `Olimpiada para Pruebas de Carga ${fecha.toISOString()}`,
        sigla: 'AAGCS2021',
        gestion: 2021,
