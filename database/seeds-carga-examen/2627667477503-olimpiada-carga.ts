...
export class fakeOlimpiadaCarga2627667477503 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const olimpiadasItems = [
      {
        id: TextService.textToUuid(`olimpiada-carga-examen${INITIAL}`),
        nombre: `Olimpiada para Pruebas de Carga Examen ${fecha.toISOString()}`,
        sigla: 'AAEE2021',
        gestion: 2021,
        fechaInicio: new Date('2021-08-13'),
        fechaFin: new Date('2021-11-10'),
        fechaCreacion: new Date(),
        usuarioCreacion: '1',
        logo: 'milogo',
        leyenda: 'olimpiada-examen-online',
      },
    ];
