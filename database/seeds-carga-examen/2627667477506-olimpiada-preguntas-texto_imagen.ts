...
export class fakePreguntasTextoImagen2627667477506 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // PREGUNTAS NIVEL BASICO
      for (let idx = 0; idx < tam; idx++) {
        ...
        _pregunta.idEtapaAreaGrado = TextService.textToUuid(`eag-carga-fisica-examen${INITIAL}`); //'793e2227-770d-5692-8852-d9efdcc6a4d7';
